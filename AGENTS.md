...
- The `wittTests` target has 115 passing simulator tests covering persistence, containment and management mutations, Browse restoration, atomic QR creation/replacement, QR routing/scanning/printing and thermal geometry, photo normalization, AI transport and management-form helpers, presentation behavior, and Place sharing helpers.
