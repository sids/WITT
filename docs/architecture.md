...
The `wittTests` target currently contains 115 simulator tests. The baseline covers:
...
6. Preserve the 115-test baseline and add focused regression coverage for any release-gate fixes. Treat [todo.md](todo.md) as the authority for current TestFlight gates and completion state rather than copying a live backlog into this document.
